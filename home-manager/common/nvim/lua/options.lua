...
vim.opt.history = 200 -- I don't need to store 10k lines of history
...
vim.opt.showmode = false -- we don't need to see things like -- INSERT -- anymore because it's handled by lualine
